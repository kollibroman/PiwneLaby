...
export default function GameEditPage({ params }: EditPageProps) {
  ...
  if (!user) {
    return (
      <div style={styles.page}>
        <div style={styles.notFound}>
          <h1 style={styles.notFoundTitle}>Zaloguj się</h1>
          <p style={styles.notFoundText}>Musisz być zalogowany, aby edytować grę.</p>
          <Link href="/auth" style={styles.backButton}>
  ...
  if (game.ownerId && user.uid !== game.ownerId) {
    return (
      <div style={styles.page}>
        <div style={styles.notFound}>
          <h1 style={styles.notFoundTitle}>Brak uprawnień</h1>
          <p style={styles.notFoundText}>Możesz edytować tylko swoje gry.</p>
          <Link href={`/games/${id}`} style={styles.backButton}>
